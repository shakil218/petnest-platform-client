...
const PetDetailsClient = ({ pet, currentUser }) => {
  // Check if the current logged-in user is the creator of this pet listing
  const isOwner = pet.ownerEmail === currentUser?.email;
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-start">
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="text-right shrink-0">
                ...
                <p className="text-3xl font-black text-error">${pet.adoptionFee}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="bg-base-200 border border-base-100 p-4 rounded-xl flex items-center gap-3 shadow-xs">
                <div className="text-error"><PawPrint size={20} /></div>
                <div>
                  <p className="text-xs text-base-content/50 font-medium">Species</p>
                  <p className="text-sm font-bold text-base-content">{pet.species}</p>
                </div>
              </div>

              {/* Breed */}
              <div className="bg-base-200 border border-base-100 p-4 rounded-xl flex items-center gap-3 shadow-xs">
                <div className="text-error"><Sparkles size={20} /></div>
                <div>
                  <p className="text-xs text-base-content/50 font-medium">Breed</p>
                  <p className="text-sm font-bold text-base-content">{pet.breed}</p>
                </div>
              </div>

              {/* Age */}
              <div className="bg-base-200 border border-base-100 p-4 rounded-xl flex items-center gap-3 shadow-xs">
                <div className="text-error"><Calendar size={20} /></div>
                <div>
                  <p className="text-xs text-base-content/50 font-medium">Age</p>
                  <p className="text-sm font-bold text-base-content">{pet.age || "2 years"}</p>
                </div>
              </div>

              {/* Gender */}
              <div className="bg-base-200 border border-base-100 p-4 rounded-xl flex items-center gap-3 shadow-xs">
                <div className="text-error"><User size={20} /></div>
                <div>
                  <p className="text-xs text-base-content/50 font-medium">Gender</p>
                  <p className="text-sm font-bold text-base-content">{pet.gender || "Male"}</p>
                </div>
              </div>

              {/* Location */}
              <div className="bg-base-200 border border-base-100 p-4 rounded-xl flex items-center gap-3 shadow-xs">
                <div className="text-error"><MapPin size={20} /></div>
                <div>
                  <p className="text-xs text-base-content/50 font-medium">Location</p>
                  <p className="text-sm font-bold text-base-content">{pet.location}</p>
                </div>
              </div>

              {/* Adoption Fee Box */}
              <div className="bg-base-200 border border-base-100 p-4 rounded-xl flex items-center gap-3 shadow-xs">
                <div className="text-error"><DollarSign size={20} /></div>
                <div>
                  <p className="text-xs text-base-content/50 font-medium">Adoption Fee</p>
                  <p className="text-sm font-bold text-base-content">${pet.adoptionFee}</p>
                </div>
              </div>

              {/* Health Status */}
              <div className="bg-base-200 border border-base-100 p-4 rounded-xl flex items-center gap-3 shadow-xs">
                <div className="text-error"><HeartPulse size={20} /></div>
                <div>
                  <p className="text-xs text-base-content/50 font-medium">Health Status</p>
                  <p className="text-sm font-bold text-base-content">{pet.healthStatus || "Excellent"}</p>
                </div>
              </div>

              {/* Vaccinated */}
              <div className="bg-base-200 border border-base-100 p-4 rounded-xl flex items-center gap-3 shadow-xs">
                <div className="text-error"><Syringe size={20} /></div>
                <div>
                  <p className="text-xs text-base-content/50 font-medium">Vaccinated</p>
                  <p className="text-sm font-bold text-base-content">{pet.vaccinated || "Yes"}</p>
                </div>
              </div>
            </div>
          ...
          <div className="md:col-span-2">
            {isOwner ? (
              /* IMAGE 1: OWNER ACCESS WARNING DISPLAY */
              <div className="bg-base-200 border border-base-100 rounded-2xl p-8 flex flex-col items-center justify-center text-center space-y-4 shadow-xl">
                ...
                <h3 className="text-xl font-black text-base-content">This is your listing</h3>
              ...
              <div className="bg-base-200 border border-base-100 rounded-2xl p-6 shadow-xl space-y-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="form-control w-full">
                    <label className="label py-1 text-xs font-semibold text-base-content/70">Pet Name</label>
                    <input
                      type="text"
                      value={pet.petName}
                      disabled
                  ...
                  {/* User Name (Read-only) */}
                  <div className="form-control w-full">
                    <label className="label py-1 text-xs font-semibold text-base-content/70">Your Name</label>
                    <div className="relative flex items-center">
                      <User className="absolute left-4 text-base-content/40" size={16} />
                      <input
                        type="text"
                  ...
                  <div className="form-control w-full">
                    <label className="label py-1 text-xs font-semibold text-base-content/70">Your Email</label>
                    <div className="relative flex items-center">
                      <Mail className="absolute left-4 text-base-content/40" size={16} />
                      <input
                        type="email"
                  ...
                  <div className="form-control w-full">
                    <label className="label py-1 text-xs font-semibold text-base-content/70">Preferred Pickup Date</label>
                    <div className="relative flex items-center">
                      <Calendar className="absolute left-4 text-base-content/40 pointer-events-none" size={16} />
                      <input
                        type="date"
                        name="pickupDate"
                        required
                  ...
                  {/* Message to Owner */}
                  <div className="form-control w-full">
                    <label className="label py-1 text-xs font-semibold text-base-content/70">Message to Owner</label>
                    <textarea
                      name="message"
                      required
                      rows={3}
